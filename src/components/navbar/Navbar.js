...
const Navbar = () => {
  ...
  return (
    <div
      className={`header h-[70px]  bg-skin-base flex items-center justify-between px-2 shadow-lg fixed ${
    ...
    >
      <div className="flex w-[30%] items-center gap-2">
        <div
          ...
          className="bg-white p-2 text-slate-700 rounded-[50%] hover:cursor-pointer hover:bg-slate-100"
        >
          <Menu />
        </div>
